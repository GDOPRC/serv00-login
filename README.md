...
1. **创建 Telegram Bot**
    ...
    - 获取到你的 Chat ID 方法，可以通过向 Bot 发送一条消息，然后访问 `https://api.telegram.org/bot(替换成你机器人的API，括号也一起替换掉)/getUpdates` 找到 Chat ID。
...
- **TELEGRAM_CHAT_ID**
    - 示例值: `1234567890`
    - 获取方法: 发送一条消息给你的 Bot，然后访问 `https://api.telegram.org/bot(替换成你机器人的API，括号也一起替换掉)/getUpdates` 获取 Chat ID。
...
## 🌟🌟🌟Star！！！走起
[![Stargazers over time](https://starchart.cc/gdoprc/serv00-login.svg?variant=adaptive)](https://starchart.cc/gdoprc/serv00-login)
